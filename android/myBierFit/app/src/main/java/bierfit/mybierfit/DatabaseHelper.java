...
//            return true;
    ...
    public boolean loginUser(String name, String password) {
        ...
        User dummy = new User();
        dummy.setUsername(c.getString(c.getColumnIndex(USER_COLUMN_NAME)));
        dummy.setEmail((c.getString(c.getColumnIndex(USER_COLUMN_EMAIL))));
        dummy.setEncrypted_password(c.getString(c.getColumnIndex(USER_COLUMN_ENC_PW)));
        closeDB();


        if (dummy.getUsername().equals(name) && dummy.getEncrypted_password().equals(password)) {
            ...
            dummy.setEmail((c.getString(c.getColumnIndex(USER_COLUMN_EMAIL))));
            dummy.setEncrypted_password(c.getString(c.getColumnIndex(USER_COLUMN_ENC_PW)));
            Log.e("loged user: ", dummy.toString());
            closeDB();
            return true;
        }
        else
...
//        return false;
    ...
    public User getLogedUser() {
        ...
        dummy.setEmail((c.getString(c.getColumnIndex(USER_COLUMN_EMAIL))));
        dummy.setEncrypted_password(c.getString(c.getColumnIndex(USER_COLUMN_ENC_PW)));
        Log.e("updated user: ", dummy.toString());
        closeDB();
        return dummy;
    }
    ...
    public void updateUser(String original, String name, String password, String email) {
        ...
        values.put(USER_COLUMN_ENC_PW, password);
        values.put(USER_COLUMN_EMAIL, email);

        Log.e("user update: ", name + ", " + password + ", " + email);
        //insert row
        long user_id = db.update(TABLE_USER, values, USER_COLUMN_NAME + " LIKE ?",
                new String[]{String.valueOf(original)});
        closeDB();
